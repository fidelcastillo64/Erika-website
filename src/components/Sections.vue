<template>
    <section class="w-full h-120 flex flex-col md:flex-row justify-center items-center text-[var(--text)] gap-0 text-left">
    ...
    <section class="h-130 w-full parallax  md:bg-center bg-position-[bottom:30%]">
